...
LOGO="/Library/Application Support/Snapsheet/Snapsheet_Phone_1Color-Black.png"

# The title of the message that will be displayed to the user.
# Not too long, or it'll get clipped.
PROMPT_TITLE="FileVault Encryption Key"
...
PROMPT_MESSAGE="Your MacBook's FileVault encryption key needs to be escrowed by Snapsheet IT.
Click the Next button below, then enter your computer password when prompted."
...
Please contact IT through help.snapsheet.me for more support."
...
FAIL_MESSAGE="Sorry, an error occurred while escrowing your FileVault key. Please contact IT by emailing helpdesk@snapsheet.me."
